...
export const TradesTab: React.FC<TradesTabProps> = ({
  ...
  console.log("Rendering TradesTab with trades:", {
    filteredTrades,
    searchTerm,
    error,
  });
  ...
  return (
    <div className="bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-6 rounded-3xl border border-white/10 min-h-[71.3vh]">
