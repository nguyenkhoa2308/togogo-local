...
export default function BacktestDashboard() {
  ...
  console.log("selectedBotId:", dashboardData.selectedBotId);
  console.log("dashboardData.trades:", dashboardData.trades);
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#101828] text-white">
      <Header />
