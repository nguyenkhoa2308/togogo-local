// components/controls/BotSelector.tsx
import React from "react";
import { ChevronDown, Settings } from "lucide-react";
import { Bot, TimeFrame } from "../../types";
    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-5">
      <div className="flex flex-wrap items-center gap-4">
        ...
        <button
          ...
          className="ml-auto px-3 py-2 text-sm font-medium rounded-lg bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 transition-all flex items-center"
        >
          <Settings size={16} className="mr-1.5" />
          {showAdvancedStats ? "Ẩn chi tiết" : "Hiển thị chi tiết"}
        </button>
      </div>
    </div>
  );
